        ...
        <div className= "fl-ns col-lg-3 tl">
            <label>
                ...
                <ul>
                    ...
                    <li className= "list"><a href='' className= "link mid-gray">Forum</a></li>
                    <li className= "list" ><a href='' className= "link mid-gray"> Podcast</a></li>
                    <li className= "list" ><a href='' className= "link mid-gray"> Affiliates</a></li>
